...
class Rotor96Crypto:
    ...
    increment = [5, 7, 11, 13, 19, 23, 29, 31]  # Step increments for each rotor
        ...
        for i in range(len(pt)):
            ...
            if 32 <= b <= 127:  # Process only printable ASCII characters
                ...
                for r in range(8):  # Pass through 8 rotors
                    ...
                    print(f"   After rotor {r} ({'ENC' if mode == Rotor96Crypto.ENC else 'DEC'}): {b}+32 = '{chr(b+32)}'")
    ...
    def rote1(r, rotor, b):
        ...
        print(f"   rote1 - Rotor {r}, Input {b}, Offset {Rotor96Crypto.offset[r]}, Output {transformed_b}")
        Rotor96Crypto.offset[r] = (Rotor96Crypto.offset[r] + Rotor96Crypto.increment[r]) % 96
    ...
    def rotd1(r, rotor, b):
        ...
        print(f"   rotd1 - Rotor {r}, Input {b}, Offset {Rotor96Crypto.offset[r]}, Output {transformed_b}")
        Rotor96Crypto.offset[r] = (Rotor96Crypto.offset[r] + Rotor96Crypto.increment[r]) % 96
        return transformed_b
